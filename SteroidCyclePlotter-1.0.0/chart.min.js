...
!function(t, e) {
  ...
  : "function" == typeof define && define.amd
    ...
    const h = (t, e) => "string" == typeof t && t.endsWith("%")
                            ? parseFloat(t) / 100
                            : +t / e,
          c = (t, e) => "string" == typeof t && t.endsWith("%")
                            ? parseFloat(t) / 100 * e
                            : +t;
    function d(t, e, i) {
    ...
    const k = t => void 0 !== t, S = t => "function" == typeof t,
          P = (t, e) => {
            if (t.size !== e.size)
              return !1;
            for (const i of t)
    ...
    const C = Math.PI, O = 2 * C, A = O + C, T = Number.POSITIVE_INFINITY,
          L = C / 180, E = C / 2, R = C / 4, I = 2 * C / 3, z = Math.log10,
          F = Math.sign;
    ...
    function N(t) {
      return !function(t) {
        return "symbol" == typeof t || "object" == typeof t && null !== t &&
                                           !(Symbol.toPrimitive in t ||
                                             "toString" in t || "valueOf" in t)
    ...
    function J(t, e, i, s) {
      const n = G(t), o = G(e), a = G(i), r = G(o - n), l = G(a - n),
            h = G(n - o), c = G(n - a);
    ...
    function rt(t, e) {
      ...
      -1 !== n && s.splice(n, 1),
          s.length > 0 || (ot.forEach((e => {delete t[e]})), delete t._chartjs)
    }
    function lt(t) {
      const e = new Set(t);
      return e.size === t.length ? t : Array.from(e)
    }
    const ht = "undefined" == typeof window ? function(t) { return t() }
    ...
    const ut = t => "start" === t ? "left"
                    : "end" === t ? "right"
                                  : "center",
          ft = (t, e, i) => "start" === t ? e
                            : "end" === t ? i
                                          : (e + i) / 2,
          gt = (t, e, i, s) => t === (s ? "left" : "right") ? i
                               : "center" === t             ? (e + i) / 2
                                                            : e;
    function pt(t, e, i) {
      const n = e.length;
      ...
      if (t._sorted) {
       ...
       {min : u, max : f, minDefined : g, maxDefined : p} = r.getUserBounds();
        if (g) {
          if (o = Math.min(it(h, d, u).lo,
                           i ? n : it(e, d, r.getPixelForValue(u)).lo),
              c) {
            const t =
                h.slice(0, o + 1).reverse().findIndex((t => !s(t[l.axis])));
            o -= Math.max(0, t)
          }
          o = Z(o, 0, n - 1)
        }
        if (p) {
          let t = Math.max(it(h, r.axis, f, !0).hi + 1,
    ...
    class xt {
      ...
      _update(t = Date.now()) {
        ...
        this._charts.forEach(((i, s) => {
          ...
          r && (s.draw(), this._notify(s, i, t, "progress")),
              n.length || (i.running = !1, this._notify(s, i, t, "complete"),
                           i.initial = !1),
              e += n.length
        })),
      ...
      start(t) {
        ...
        e && (e.running = !0, e.start = Date.now(),
              e.duration =
    ...
    const St = {
      ...
      f : 15
          ...
          Pt = [..."0123456789ABCDEF" ], Dt = t => Pt[15 & t],
    ...
    function It(t) {
      ...
      let r, l, h;
      return n !== o && (h = n - o, l = a > .5 ? h / (2 - n - o) : h / (n + o),
                         r =
                             function(t, e, i, s, n) {
    ...
    function Bt(t) {
      ...
      return i = "hwb" === e[1]
                     ? function(t, e, i) { return zt(Rt, t, e, i) }(n, o, a)
                 : "hsv" === e[1]
                     ? function(t, e, i) { return zt(Et, t, e, i) }(n, o, a)
                     : Ft(n, o, a),
      {
    ...
    function Xt(t, e, i) {
      if (t) {
        ...
        s = Ft(s), t.r = s[0], t.g = s[1], t.b = s[2]
      }
    }
    ...
    class Jt {
      ...
      rgbString() {
        return this._valid
                   ? (t = this._rgb) &&
                         (t.a < 255 ? `rgba(${t.r}, ${t.g}, ${t.b}, ${wt(t.a)})`
                                    : `rgb(${t.r}, ${t.g}, ${t.b})`)
                   : void 0;
        var t
      }
    ...
    const oe = {
      ...
      logarithmic(t, e, i) {
        ...
        return [ 1, 2, 3, 5, 10, 15 ].includes(s) || e > .8 * i.length
    ...
    class de {
      constructor(t, e) {
        ...
        this.hoverColor = (t, e) => te(e.color), this.indexAxis = "x",
        this.interaction = {
          mode : "nearest",
          intersect : !0,
          includeInvisible : !1
        ...
        this.drawActiveElementsOnTop = !0, this.describe(t), this.apply(e)
      }
        ...
        [
          ...
          function(t) {
            t.set("scale", {
              ...
              title :
                  {display : !1, text : "", padding : {top : 4, bottom : 4}},
              ticks : {
                minRotation : 0,
                maxRotation : 50,
                mirror : !1,
                ...
                t.describe("scale", {
                  _fallback : !1,
                  _scriptable : t => !t.startsWith("before") &&
                                     !t.startsWith("after") &&
                                     "callback" !== t && "parser" !== t,
                  _indexable : t => "borderDash" !== t &&
                                    "tickBorderDash" !== t && "dash" !== t
                }),
    ...
    function ve(t, e) {
      ...
      const {canvas : i,
             currentDevicePixelRatio :
                 s} = e,
                 n = me(i), o = "border-box" === n.boxSizing,
                 a = _e(n, "padding"), r = _e(n, "border", "width"),
    ...
    function we(t, e, i, s) {
      const n = me(t), o = _e(n, "margin"),
            ...
            r = pe(n.maxHeight, t, "clientHeight") || T, l = function(t, e, i) {
              ...
              if (void 0 === e || void 0 === i) {
                const o = t && ge(t);
                if (o) {
                  const t = o.getBoundingClientRect(), a = me(o),
                        r = _e(a, "border", "width"), l = _e(a, "padding");
      ...
      h = Math.max(0, h - o.width), c = Math.max(0, s ? h / s : c - o.height),
      h = Me(Math.min(h, a, l.maxWidth)), c = Me(Math.min(c, r, l.maxHeight)),
      h && !c && (c = Me(h / 2));
    ...
    function ke(t, e, i) {
      ...
      const a = t.canvas;
      a.style && (i || !a.style.height && !a.style.width) &&
          (a.style.height = `${t.height}px`, a.style.width = `${t.width}px`);
      const r = Math.floor(n), l = Math.floor(o);
      return (t.currentDevicePixelRatio !== s || a.height !== r ||
              a.width !== l) &&
             (t.currentDevicePixelRatio = s, a.height = r, a.width = l,
    ...
    function Te(t, e) {
      (e || t) && ((e = e || t.getContext("2d")).save(), e.resetTransform(),
    ...
    function Ee(t, e, i, s, n) {
      ...
      if (f && "object" == typeof f &&
          (o = f.toString(), "[object HTMLImageElement]" === o ||
                                 "[object HTMLCanvasElement]" === o))
        return t.save(), t.translate(i, s), t.rotate(m),
      ...
      if (!(isNaN(p) || p <= 0)) {
        ...
        default:
          ...
          break;
        case "triangle":
          c = n ? n / 2 : p, t.moveTo(i + Math.sin(m) * c, s - Math.cos(m) * p),
          m += I, t.lineTo(i + Math.sin(m) * c, s - Math.cos(m) * p), m += I,
          t.lineTo(i + Math.sin(m) * c, s - Math.cos(m) * p), t.closePath();
          break;
        case "rectRounded":
          h = .516 * p, l = p - h, a = Math.cos(m + R) * l,
          d = Math.cos(m + R) * (n ? n / 2 - h : l), r = Math.sin(m + R) * l,
          u = Math.sin(m + R) * (n ? n / 2 - h : l),
          t.arc(i - d, s - r, h, m - C, m - E),
          t.arc(i + u, s - a, h, m - E, m), t.arc(i + d, s + r, h, m, m + E),
          t.arc(i - u, s + a, h, m + E, m + C), t.closePath();
          break;
        case "rect":
          if (!g) {
            l = Math.SQRT1_2 * p, c = n ? n / 2 : l,
            t.rect(i - c, s - l, 2 * c, 2 * l);
            break
          }
          m += R;
        case "rectRot":
          d = Math.cos(m) * (n ? n / 2 : p), a = Math.cos(m) * p,
          r = Math.sin(m) * p, u = Math.sin(m) * (n ? n / 2 : p),
          t.moveTo(i - d, s - r), t.lineTo(i + u, s - a),
          t.lineTo(i + d, s + r), t.lineTo(i - u, s + a), t.closePath();
          break;
        case "crossRot":
          m += R;
        case "cross":
          d = Math.cos(m) * (n ? n / 2 : p), a = Math.cos(m) * p,
          r = Math.sin(m) * p, u = Math.sin(m) * (n ? n / 2 : p),
          t.moveTo(i - d, s - r), t.lineTo(i + d, s + r),
        ...
        case "star":
          ...
          r = Math.sin(m) * p, u = Math.sin(m) * (n ? n / 2 : p),
          t.moveTo(i - d, s - r), t.lineTo(i + d, s + r),
          t.moveTo(i + u, s - a), t.lineTo(i - u, s + a), m += R,
          d = Math.cos(m) * (n ? n / 2 : p), a = Math.cos(m) * p,
          r = Math.sin(m) * p, u = Math.sin(m) * (n ? n / 2 : p),
          t.moveTo(i - d, s - r), t.lineTo(i + d, s + r),
          t.moveTo(i + u, s - a), t.lineTo(i - u, s + a);
          break;
        case "line":
          a = n ? n / 2 : Math.cos(m) * p, r = Math.sin(m) * p,
    ...
    function Re(t, e, i) {
      return i = i || .5, !e || t && t.x > e.left - i && t.x < e.right + i &&
    ...
    function Ve(t, e, i, s) {
      if (!e)
        return t.lineTo(i.x, i.y);
      t.bezierCurveTo(s ? e.cp1x : e.cp2x, s ? e.cp1y : e.cp2y,
                      s ? i.cp2x : i.cp1x, s ? i.cp2y : i.cp1y, i.x, i.y)
    }
    ...
    function We(t, e) {
      const i = t.fillStyle;
      t.fillStyle = e.color, t.fillRect(e.left, e.top, e.width, e.height),
      t.fillStyle = i
    }
    function Ne(t, e, i, o, a, r = {}) {
      ...
      for (t.save(), t.font = a.string, function(t, e) {
        ...
        t.fillText(d, i, o, r.maxWidth), Be(t, i, o, d, r),
    ...
    function He(t, e) {
      ...
      t.arc(i + a.topLeft, s + a.topLeft, a.topLeft, 1.5 * C, C, !0),
          ...
          t.arc(i + n - a.bottomRight, s + o - a.bottomRight, a.bottomRight, E,
                0, !0),
    ...
    function $e(t, e, i, s) {
      ...
      return new Proxy(a, {
        ...
        get : (t, e, i) =>
            qe(t, e, (() => function(t, e, i) {
                 ...
                 S(h) && l.isScriptable(e) && (h = function(t, e, i, s) {
                   const {_proxy : n, _context : o, _subProxy : a, _stack : r} =
                       i;
                   if (r.has(t))
        ...
        getOwnPropertyDescriptor : (e, i) =>
            e._descriptors.allKeys ? Reflect.has(t, i)
    ...
    function Ye(t, e = {scriptable : !0, indexable : !0}) {
      ...
      return {
        allKeys: n, scriptable: i, indexable: s,
            isScriptable: S(i) ? i : () => i, isIndexable: S(s) ? s : () => s
      }
    }
    ...
    function Ze(t, e, i, s) {
      const a = e._rootScopes, r = Ke(e._fallback, i, s), l = [...t, ...a ],
            h = new Set;
      h.add(s);
      ...
      return null !== c &&
             ((void 0 === r || r === i ||
              ...
              je(Array.from(h), [ "" ], a, r, (() => function(t, e, i) {
    ...
    const si = Number.EPSILON || 1e-14,
          ...
          oi = t => "x" === t ? "y" : "x";
    function ai(t, e, i, s) {
      const n = t.skip ? e : t, o = e, a = i.skip ? e : i, r = q(o, n),
            l = q(a, o);
      let h = r / (r + l), c = l / (r + l);
    ...
    function ri(t, e = "x") {
      ...
      for (a = 0; a < s; ++a)
        if (r = l, l = h, h = ni(t, a + 1), l) {
          ...
          o[a] = r ? h ? F(n[a - 1]) !== F(n[a]) ? 0 : (n[a - 1] + n[a]) / 2
                       : n[a - 1]
                   : n[a]
        }
      !function(t, e, i) {
          ...
          l && h &&
              (V(e[c], 0, si)
                   ...
                   : (n = i[c] / e[c], o = i[c + 1] / e[c],
                      ...
                      r <= 9 || (a = 3 / Math.sqrt(r), i[c] = n * a * e[c],
                                 i[c + 1] = o * a * e[c])))
      }(t, n, o),
          function(t, e, i = "x") {
            ...
            for (let h = 0; h < n; ++h) {
              if (a = r, r = l, l = ni(t, h + 1), !r)
                continue;
              const n = r[i], c = r[s];
              a && (o = (n - a[i]) / 3, r[`cp1${i}`] = n - o,
                    r[`cp1${s}`] = c - o * e[h]),
                  l && (o = (l[i] - n) / 3, r[`cp2${i}`] = n + o,
                        r[`cp2${s}`] = c + o * e[h])
            }
          }(t, o, e)
    }
    ...
    const ci = t => 0 === t || 1 === t,
          ...
          ui = (t, e, i) =>
            ...
            easeInOutBounce : t => t < .5
                                       ? .5 * fi.easeInBounce(2 * t)
                                       : .5 * fi.easeOutBounce(2 * t - 1) + .5
          };
    function gi(t, e, i, s) {
    ...
    function pi(t, e, i, s) {
      return {
        x: t.x + i * (e.x - t.x), y: "middle" === s ? i < .5 ? t.y : e.y
                                  : "after" === s   ? i < 1 ? t.y : e.y
                                  : i > 0           ? e.y
                                                    : t.y
      }
    ...
    function mi(t, e, i, s) {
      const n = {x : t.cp2x, y : t.cp2y}, o = {x : e.cp1x, y : e.cp1y},
            a = gi(t, n, i), r = gi(n, o, i), l = gi(o, e, i), h = gi(a, r, i),
            c = gi(r, l, i);
      return gi(h, c, i)
    }
    const
    ...
    function Di(t, e, i) {
      const {min : s, max : n} = t, o = c(e, (n - s) / 2),
                            a = (t, e) => i && 0 === t ? 0 : t + e;
    ...
    function Ri(t, e, i) {
     ...
     a = e.length, {compare : r, between : l, normalize : h} = Li(s),
     {start : c, end : d, loop : u, style : f} = function(t, e, i) {
      ...
      return null !== _ &&
                 g.push(
                     Ei({start : _, end : d, loop : u, count : a, style : f})),
             g
    }
    function Ii(t, e) {
    ...
    var Hi = Object.freeze({
      ...
      _deprecated : function(t, e, i, s) {
        void 0 !== e &&
            console.warn(t + ': "' + i + '" is deprecated. Please use "' + s +
                         '" instead')
      },
      _descriptors : Ye,
      _elementsEqual : f,
      ...
      easingEffects : fi,
      finiteOrDefault : r,
      fontString : function(t, e, i) { return e + " " + t + "px " + i },
      formatNumber : ne,
      getAngleFromPoint : X,
    ...
    function Yi(t, e, i, s, n) {
      ...
      return $i(t, i, e, (function(i, a, r) {
                  (n || Re(i, t.chartArea, 0)) && i.inRange(e.x, e.y, s) &&
    ...
    function Ui(t, e, i, s, n, o) {
      ...
      return $i(t, i, e, (function(i, h, c) {
                  ...
                  if (!(!!o || t.isPointInArea(u)) && !d)
                    return;
                  const f = r(e, u);
                  f < l ? (a = [ {element : i, datasetIndex : h, index : c} ],
                           l = f)
                        : f === l &&
    ...
    function ss(t, e, i, s) {
      ...
      if (!o(n)) {
        ...
        i.size = e.size / e.count, t[n] += i.size
      }
    ...
    function rs(t, e, i, s) {
      ...
      for (const r of t) {
        ...
        if (r.horizontal) {
          ...
          k(l.start) && (a = l.start),
              t.fullSize ? as (t, n.left, a, i.outerWidth - n.right - n.left, o)
                         : as (t, e.left + l.placed, a, s, o),
              l.start = a, l.placed += s, a = t.bottom
        } else {
          const s = e.h * h, a = l.size || t.width;
          k(l.start) && (o = l.start),
              t.fullSize ? as (t, o, n.top, a, i.outerHeight - n.bottom - n.top)
    ...
    var ls = {
      addBox(t, e) {
        t.boxes || (t.boxes = []),
            ...
            e._layers =
                e._layers ||
                function() { return [ {z : 0, draw(t) { e.draw(t) }} ] },
            t.boxes.push(e)
      },
      removeBox(t, e) {
      ...
      update(t, e, i, s) {
        if (!t)
          return;
        const n = ki(t.options.layout.padding), o = Math.max(e - n.width, 0),
              a = Math.max(i - n.height, 0), r = function(t) {
                const e =
                  ...
                  return e
                      ...
                      s = Qi(Ji(e, "left"), !0), n = Qi(Ji(e, "right")),
                      o = Qi(Ji(e, "top"), !0), a = Qi(Ji(e, "bottom")),
                      r = Zi(e, "x"), l = Zi(e, "y");
                return {
        ...
        const g = Object.assign(
              ...
              p = ts(l.concat(h), d);
        os(r.fullSize, g, d, p), os(l, g, d, p),
            ...
            rs(r.leftAndTop, g, d, p), g.x += g.w, g.y += g.h,
    ...
    function vs() {
      ...
      t !== ys &&
          (ys = t,
           _s.forEach(((e, i) => {i.currentDevicePixelRatio !== t && e()})))
    }
    function Ms(t, e, i) {
      ...
      acquireContext(t, e) {
        ...
        return i && i.canvas === t ? (function(t, e) {
          ...
          if (t[ds] = {
              ...
              i.boxSizing = i.boxSizing || "border-box", fs(n)) {
            const e = Pe(t, "width");
            void 0 !== e && (t.width = e)
          }
          if (fs(s))
    ...
    function Ps(t) {
      return !fe() || "undefined" != typeof OffscreenCanvas &&
    ...
    class As {
      constructor(t, e, i, s) {
        ...
        this._active = !0, this._fn = t.fn || Os[t.type || typeof o],
    ...
    class Ts {
      ...
      configure(t) {
        ...
        Object.getOwnPropertyNames(t).forEach((s => {
          ...
          (n(a.properties) && a.properties || [
            s
          ]).forEach((t => {t !== s && i.has(t) || i.set(t, r)}))
        }))
      }
      _animateOptions(t, e) {
      ...
      _createAnimations(t, e) {
        ...
        for (r = o.length - 1; r >= 0; --r) {
          ...
          d && d.duration ? (n[l] = c = new As(d, t, l, h), s.push(c))
                          : t[l] = h
        }
        return s
      }
    ...
    function Vs(t, e) {
     ...
     l = o.axis, h = a.axis,
     c = function(t, e,
                  i) { return `${t.id}.${e.id}.${i.stack || i.type}` }(o, a, s),
     d = e.length;
      let u;
      for (let t = 0; t < d; ++t) {
        const i = e[t], {[l] : o, [h] : d} = i;
        u = (i._stacks || (i._stacks = {}))[h] = zs(n, c, o), u[r] = d,
        u._top = Fs(u, a, !0, s.type), u._bottom = Fs(u, a, !1, s.type);
      ...
      if (s) {
        ...
        for (const t of e) {
          ...
          if (!e || void 0 === e[s] || void 0 === e[s][i])
            return;
          delete e[s][i], void 0 !== e[s]._visualValues &&
    ...
    class js {
      ...
      initialize() {
        ...
        this.configure(), this.linkScales(),
            t._stacked = Is(t.vScale, t), this.addElements(),
      ...
      linkScales() {
        const t = this.chart, e = this._cachedMeta, i = this.getDataset(),
              ...
              a = e.rAxisID = l(i.rAxisID, Bs(t, "r")), r = e.indexAxis,
      ...
      _dataCheck() {
        ...
        if (o(e)) {
          ...
          this._data = function(t, e) {
            const {iScale : i, vScale : s} = e, n = "x" === i.axis ? "x" : "y",
                                        o = "x" === s.axis ? "x" : "y",
                                        a = Object.keys(t),
          ...
          e && Object.isExtensible(e) && at(e, this), this._syncList = [],
                                                      this._data = e
        }
      }
      addElements() {
      ...
      parse(t, e) {
        ...
        if (!1 === this._parsing)
          ...
          d = n(s[t])   ? this.parseArrayData(i, s, t, e)
              : o(s[t]) ? this.parseObjectData(i, s, t, e)
      ...
      applyStack(t, e, i) {
        ...
        return Rs({keys : Es(s, !0), values : e._stacks[t.axis]._visualValues},
                  o, n.index, {mode : i})
      }
      ...
      getMinMax(t, e) {
        const i = this._cachedMeta, s = i._parsed,
              n = i._sorted && t === i.iScale, o = s.length,
              r = this._getOtherScale(t),
              l = ((t, e, i) => t && !e.hidden && e._stacked &&
                                {keys : Es(i, !0), values : null})(e, i,
                                                                   this.chart),
              h = {
      ...
      _update(t) {
        ...
        this.update(t || "default"),
            e._clip = function(t) {
              let e, i, s, n;
              return o(t) ? (e = t.top, i = t.right, s = t.bottom, n = t.left)
                          : e = i = s = n = t,
              {
      ...
      _resolveElementOptions(t, e = "default", i) {
        const s = "active" === e, n = this._cachedDataOpts, o = t + "-" + e,
              a = n[o], r = this.enableOptionSharing && k(i);
        if (a)
          return Hs(a, r);
        const l = this.chart.config,
              ...
              f = l.resolveNamedOptions(d, u, (() => this.getContext(i, s, e)),
                                        c);
      ...
      _resyncElements(t) {
        ...
        o && this.parse(0, o), n > s ? this._insertElements(s, n - s, t)
    ...
    class tn extends $s {
      ...
      getMinMax(t) {
        let e, {min : i, max : s, minDefined : n, maxDefined : o} =
                   this.getUserBounds();
        if (n && o)
          return {min : i, max : s};
        const a = this.getMatchingVisibleMetas();
        for (let r = 0, l = a.length; r < l; ++r)
          e = a[r].controller.getMinMax(this, t), n || (i = Math.min(i, e.min)),
      ...
      update(t, e, i) {
        ...
        this.beforeUpdate(),
            ...
            this._dataLimitsCached ||
                (this.beforeDataLimits(), this.determineDataLimits(),
                 this.afterDataLimits(), this._range = Di(this, n, s),
        ...
        this._convertTicksToLabels(r ? Ks(this.ticks, a) : this.ticks),
            ...
            o.display && (o.autoSkip || "auto" === o.source) &&
                (this.ticks = Ys(this, this.ticks), this._labelSizes = null,
                 this.afterAutoSkip()),
      ...
      calculateLabelRotation() {
        ...
        c + 6 > o &&
            (o = u / (i - (t.offset ? .5 : 1)),
             a = this.maxHeight - Js(t.grid) - e.padding -
                 Zs(t.title, this.chart.options.font),
             r = Math.sqrt(c * c + d * d),
             l = Y(Math.min(Math.asin(Z((h.highest.height + 6) / o, -1, 1)),
                            Math.asin(Z(a / r, -1, 1)) -
                                Math.asin(Z(d / r, -1, 1)))),
      ...
      fit() {
        ...
        if (o) {
          ...
          if (a ? (t.width = this.maxWidth, t.height = Js(n) + o)
                : (t.height = this.maxHeight, t.width = Js(n) + o),
              i.display && this.ticks.length) {
            const {first : e,
                   last : s,
                   widest : n,
                   highest : o} = this._getLabelSizes(),
                             r = 2 * i.padding, l = $(this.labelRotation),
                             h = Math.cos(l), c = Math.sin(l);
            if (a) {
      ...
      _calculatePadding(t, e, i, s) {
        const {ticks : {align : n, padding : o},
               position : a} = this.options,
        ...
        if (!t) {
          ...
          e < i.length && (i = Ks(i, e)),
              this._labelSizes = t = this._computeLabelSizes(
                  i, i.length, this.options.ticks.maxTicksLimit)
        }
        return t
      }
      _computeLabelSizes(t, e, i) {
        const {ctx : o, _longestTextCache : a} = this, r = [], l = [],
                                            h = Math.floor(e / qs(e, i));
        let c, d, f, g, p, m, x, b, _, y, v, M = 0, w = 0;
        for (c = 0; c < e; c += h) {
          if (g = t[c].label, p = this._resolveTickFontOptions(c),
              o.font = m = p.string, x = a[m] = a[m] || {data : {}, gc : []},
        ...
        const k = r.indexOf(M), S = l.indexOf(w),
              P = t => ({width : r[t] || 0, height : l[t] || 0});
        return {
          first: P(0), last: P(e - 1), widest: P(k), highest: P(S), widths: r,
              heights: l
        }
      }
      ...
      getContext(t) {
        ...
        return this.$context ||
               (this.$context =
                    Ci(this.chart.getContext(), {scale : this, type : "scale"}))
      }
      _tickSize() {
        const t = this.options.ticks, e = $(this.labelRotation),
      ...
      _computeGridLineItems(t) {
        const e = this.axis, i = this.chart, s = this.options,
              {grid : n, position : a, border : r} = s, h = n.offset,
              c = this.isHorizontal(), d = this.ticks.length + (h ? 1 : 0),
              u = Js(n), f = [], g = r.setContext(this.getContext()),
              p = g.display ? g.width : 0, m = p / 2,
              x = function(t) { return Ae(i, t, p) };
        let b, _, y, v, M, w, k, S, P, D, C, O;
        if ("top" === a)
          b = x(this.bottom), w = this.bottom - u, S = b - m, D = x(t.top) + m,
          O = t.bottom;
        else if ("bottom" === a)
          b = x(this.top), D = t.top, O = x(t.bottom) - m, w = b + m,
          S = this.top + u;
        else if ("left" === a)
          b = x(this.right), M = this.right - u, k = b - m, P = x(t.left) + m,
          C = t.right;
        else if ("right" === a)
          b = x(this.left), P = t.left, C = x(t.right) - m, M = b + m,
          k = this.left + u;
        else if ("x" === e) {
          if ("center" === a)
        ...
        for (_ = 0; _ < d; _ += T) {
          const t = this.getContext(_), e = n.setContext(t),
                s = r.setContext(t), o = e.lineWidth, a = e.color,
                l = s.dash || [], d = s.dashOffset, u = e.tickWidth,
                g = e.tickColor, p = e.tickBorderDash || [],
                m = e.tickBorderDashOffset;
          y = Gs(this, _, h),
          void 0 !== y && (v = Ae(i, y, o),
                           c ? M = k = P = C = v : w = S = D = O = v, f.push({
                             tx1 : M,
                             ty1 : w,
                             tx2 : k,
                             ty2 : S,
      ...
      _computeLabelItems(t) {
        const e = this.axis, i = this.options, {position : s, ticks : a} = i,
              r = this.isHorizontal(), l = this.ticks,
              {align : h, crossAlign : c, padding : d, mirror : u} = a,
              f = Js(i.grid), g = f + d, p = u ? -d : g,
              m = -$(this.labelRotation), x = [];
        ...
        for (b = 0, _ = l.length; b < _; ++b) {
          ...
          P = this._resolveTickFontOptions(b), D = P.lineHeight,
          C = n(v) ? v.length : 1;
          const e = C / 2, i = t.color, o = t.textStrokeColor,
                h = t.textStrokeWidth;
          let d, f = k;
          if (r ? (M = S,
                   "inner" === k &&
                       (f = b === _ - 1
                            ...
                            : 0 === b ? this.options.reverse ? "right" : "left"
                                      : "center"),
                   O = "top" === s ? "near" === c || 0 !== m ? -C * D + D / 2
                                     : "center" === c
      ...
      o = t + n, a = this._getLabelSizes().widest.width;
        let r, l;
        return "left" === e
                   ? s ? (l = this.right + n, "near" === i ? r = "left"
                                              : "center" === i
                                                  ? (r = "center", l += a / 2)
                                                  : (r = "right", l += a))
                       : (l = this.right - o, "near" === i ? r = "right"
                                              : "center" === i
                                                  ? (r = "center", l -= a / 2)
                                                  : (r = "left", l = this.left))
               : "right" === e
                   ? s ? (l = this.left + n, "near" === i ? r = "right"
                                             : "center" === i
                                                 ? (r = "center", l -= a / 2)
                                                 : (r = "left", l -= a))
                       : (l = this.left + o,
      ...
      drawBorder() {
        ...
        this.isHorizontal() ? (l = Ae(t, this.left, o) - o / 2,
                               h = Ae(t, this.right, a) + a / 2, c = d = r)
                            : (c = Ae(t, this.top, o) - o / 2,
                               d = Ae(t, this.bottom, a) + a / 2, l = h = r),
            e.save(), e.lineWidth = n.width, e.strokeStyle = n.color,
                      e.beginPath(), e.moveTo(l, c), e.lineTo(h, d), e.stroke(),
                      e.restore()
      }
      drawLabels(t) {
      ...
      drawTitle() {
        const {ctx : t, options : {position : e, title : i, reverse : s}} =
            this;
        if (!i.display)
          return;
      ...
      _layers() {
        const t = this.options, e = t.ticks && t.ticks.z || 0,
              i = l(t.grid && t.grid.z, -1), s = l(t.border && t.border.z, 0);
    ...
    class en {
      ...
      register(t) {
        ...
        let i;
        (function(t) { return "id" in t && "defaults" in t })(e) &&
            (i = this.register(e));
        ...
        return n in s || (s[n] = t, function(t, e, i) {
                 const s = x(Object.create(null),
                             [ i ? ue.get(i) : {}, ue.get(e), t.defaults ]);
    ...
    function cn(t, ...e) {
      ...
      var i;
      throw new Error(`Cannot determine type of '${
          t}' axis. Please provide 'axis' or 'position' option.`)
    }
    function dn(t, e, i) {
      if (i[e + "AxisID"] === t)
        return { axis: e }
    ...
    function un(t, e) {
      const i = re[t.type] || {scales : {}}, s = e.scales || {},
            n = ln(t.type, e), a = Object.create(null);
      return Object.keys(s).forEach((e => {
        ...
        const l = cn(e, r,
                     ...
                     ue.scales[r.type]),
              h = function(t, e) { return t === e ? "_index_" : "_value_" }(l,
                                                                            n),
              c = i.scales || {};
        a[e] = b(Object.create(null), [ {axis : l}, r, c[l], c[h] ])
      })),
             t.data.datasets.forEach((i => {
               const n = i.type || t.type, o = i.indexAxis || ln(n, e),
                     r = (re[n] || {}).scales || {};
    ...
    class _n {
      constructor(t) {
        this._config = function(
            t) { return (t = t || {}).data = gn(t.data), fn(t), t }(t),
        this._scopeCache = new Map, this._resolverCache = new Map
      }
    ...
    function kn(t, e) {
      return function(i, s) { return i[t] === s[t] ? i[e] - s[e] : i[t] - s[t] }
    }
    function Sn(t) {
    ...
    function Dn(t) {
      return fe() && "string" == typeof t ? t = document.getElementById(t)
                                          : t && t.length && (t = t[0]),
    ...
    class Tn {
      ...
      constructor(t, e) {
        ...
        if (o)
          throw new Error("Canvas is already in use. Chart with ID '" + o.id +
        ...
        this.id = i(), this.ctx = r, this.canvas = l, this.width = c,
        ...
        this.scales = {}, this._plugins = new on, this.$proxies = {},
        ...
        this._dataChanges = [], Cn[this.id] = this,
        r && l
            ? (bt.listen(this, "complete", Sn), bt.listen(this, "progress", Pn),
      ...
      resize(t, e) {
        bt.running(this) ? this._resizeBeforeDraw = {width : t, height : e}
                         : this._resize(t, e)
      }
      _resize(t, e) {
        ...
        ke(this, a, !0) && (this.notifyPlugins("resize", {size : o}),
      ...
      buildOrUpdateScales() {
        ...
        e && (n = n.concat(Object.keys(e).map((t => {
          ...
          return {
            ...
            u(n, (e => {
                const n = e.options, o = n.id, a = cn(o, n),
                      r = l(n.type, e.dtype);
                void 0 !== n.position &&
            ...
            u(s, ((t, e) => {t || delete i[e]})),
            u(i, (t => {ls.configure(this, t, t.options), ls.addBox(this, t)}))
      }
      _updateMetasets() {
      ...
      _removeUnreferencedMetasets() {
        ...
        t.length > e.length && delete this._stacks,
            t.forEach(
                ((t, i) => {0 === e.filter((e => e === t._dataset)).length &&
      ...
      buildOrUpdateControllers() {
        ...
        for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s;
          ...
          if (n.type && n.type !== o &&
              ...
              n.type = o, n.indexAxis = s.indexAxis || ln(o, this.options),
      ...
      update(t) {
        ...
        this._updateLayout(o), s || u(n, (t => {t.reset()})),
      ...
      _updateScales() {
        u(this.scales, (t => {ls.removeBox(this, t)})),
      ...
      render() {
        !1 !== this.notifyPlugins("beforeRender", {cancelable : !0}) &&
            (bt.has(this) ? this.attached && !bt.running(this) && bt.start(this)
      ...
      _drawDataset(t) {
        const e = this.ctx, i = {meta : t, index : t.index, cancelable : !0},
              s = Ni(this, t);
        !1 !== this.notifyPlugins("beforeDatasetDraw", i) &&
            (s && Ie(e, s), t.controller.draw(), s && ze(e), i.cancelable = !1,
      ...
      _updateVisibility(t, e, i) {
        ...
        k(e) ? (n.data[e].hidden = !i, this.update())
      ...
      _stop() {
        let t, e;
        for (this.stop(), bt.remove(this), t = 0, e = this.data.datasets.length;
             t < e; ++t)
          this._destroyDatasetMeta(t)
      }
      destroy() {
        ...
        this._stop(), this.config.clearCache(),
            t &&
                (this.unbindEvents(), Te(t, e), this.platform.releaseContext(e),
                 this.canvas = null, this.ctx = null),
            delete Cn[this.id], this.notifyPlugins("afterDestroy")
      }
      ...
      bindUserEvents() {
        const t = this._listeners, e = this.platform,
      ...
      bindResponsiveEvents() {
        ...
        const t = this._responsiveListeners, e = this.platform,
              i = (i, s) => { e.addEventListener(this, i, s), t[i] = s },
              s = (i, s) => {
      ...
      setActiveElements(t) {
        ...
        !f(i, e) && (this._active = i, this._lastEvent = null,
      ...
      _updateHoverStyles(t, e, i) {
        const s = this.options.hover,
              n = (t, e) => t.filter(
                  (t => !e.some((e => t.datasetIndex === e.datasetIndex &&
                                      t.index === e.index)))),
              o = n(e, t), a = i ? t : n(t, e);
      ...
      _handleEvent(t, e, i) {
       ...
       o = e, a = this._getActiveElements(t, s, i, o), r = D(t),
       l = function(t, e, i,
                    s) { return i && "mouseout" !== t.type ? s ? e : t : null }(
           t, this._lastEvent, i, r);
        i && (this._lastEvent = null, d(n.onHover, [ t, a, this ], this),
    ...
    class Rn {
      static override(t) { Object.assign(Rn.prototype, t) }
      options;
      constructor(t) {
        this.options = t || {}
      }
    ...
    function Wn(t, e, i, s) {
      ...
      const {start : a, end : r, reverse : l, top : h, bottom : c} = function(
          t) {
        let e, i, s, n, o;
      ...
      "middle" === n && i &&
          (t.enableBorderRadius = !0, (i._top || 0) === s ? n = h
                                      : (i._bottom || 0) === s
                                          ? n = c
                                          : (o[Nn(c, a, r, l)] = !0, n = h)),
          o[Nn(n, a, r, l)] = !0, t.borderSkipped = o
    }
    function Nn(t, e, i, s) {
      var n, o, a;
      return s ? (a = i, t = Hn(t = (n = t) === (o = e) ? a
                                    : n === a           ? o
                                                        : n,
                                i, e))
               : t = Hn(t, e, i),
    ...
    class $n extends js {
      ...
      static descriptors = {
        ...
        _indexable: t => "spacing" !== t && !t.startsWith("borderDash") &&
      ...
      static overrides = {
        ...
        plugins: {
          legend: {
            labels: {
              generateLabels(t) {
                ...
                return e.labels.length && e.datasets.length
                           ? e.labels.map(((e, r) => {
                               const l =
                                   t.getDatasetMeta(0).controller.getStyle(r);
                               return {
                                 text: e, fillStyle: l.backgroundColor,
                                     fontColor: n,
                                     ...
                                     strokeStyle: l.borderColor, textAlign: s,
                                     pointStyle: i,
            ...
            onClick(
                t, e,
                i) { i.chart.toggleDataVisibility(e.index), i.chart.update() }
          }
        }
      };
      constructor(t, e) {
              ...
              {ratioX : f, ratioY : g, offsetX : p, offsetY : m} =
                ...
                if (e < O) {
                  const r = t, l = r + e, h = Math.cos(r), c = Math.sin(r),
                        ...
                        p = f(0, h, d), m = f(E, c, u), x = g(C, h, d),
                        b = g(C + E, c, u);
                  s = (p - x) / 2, n = (m - b) / 2, o = -(p + x) / 2,
                  a = -(m + b) / 2
                }
                return { ratioX: s, ratioY: n, offsetX: o, offsetY: a }
              }(u, d, r),
              x = (i.width - o) / f, b = (i.height - o) / g,
      ...
      _circumference(t, e) {
        ...
        return e && i.animation.animateRotate ||
                       ...
                       null === s._parsed[t] || s.data[t].hidden
                   ? 0
    ...
    class Yn extends js {
            ...
            labels: {
              generateLabels(t) {
                ...
                if (e.labels.length && e.datasets.length) {
                  const {labels : {pointStyle : i, color : s}} =
                      t.legend.options;
                  return e.labels.map(((e, n) => {
                    const o = t.getDatasetMeta(0).controller.getStyle(n);
                    return {
                      text: e, fillStyle: o.backgroundColor,
                          strokeStyle: o.borderColor, fontColor: s,
                          lineWidth: o.borderWidth, pointStyle: i,
                          hidden: !t.getDataVisibility(n), index: n
                    }
                  }))
                }
                return []
      ...
      _updateRadius() {
        const t = this.chart, e = t.chartArea, i = t.options,
              ...
              n = Math.max(s / 2, 0),
              o = (n - Math.max(i.cutoutPercentage
    ...
    var Un = Object.freeze({
      ...
      BarController :
        ...
        parseObjectData(t, e, i, s) {
          ...
          let d, u, f, g;
          for (d = i, u = i + s; d < u; ++d)
            g = e[d], f = {}, f[n.axis] = n.parse(M(g, l), d),
        ...
        updateElements(t, e, i, n) {
          ...
          for (let f = e; f < e + i; f++) {
            ...
            u && (m.options = d || this.resolveDataElementOptions(
        ...
        _getAxis() {
          ...
          for (const i of this.chart.data.datasets)
            t[l("x" === this.chart.options.indexAxis ? i.xAxisID : i.yAxisID,
                e)] = !0;
        ...
        _getRuler() {
          ...
          return {
            min: a || zn(e), pixels: s, start: i._startPixel, end: i._endPixel,
        ...
        r = o || 0, l = this.getParsed(t), h = l._custom, c = Bn(h);
          ...
          p !== f && (g = p - f, p = f),
              c && (f = h.barStart, p = h.barEnd - h.barStart,
                    0 !== f && F(f) !== F(h.barEnd) && (g = 0), g += f);
          const m = s(o) || c ? g : o;
          let x = e.getPixelForValue(m);
          if (d = this.chart.getDataVisibility(t) ? e.getPixelForValue(g + p)
                                                  : x,
              u = d - x, Math.abs(u) < a) {
            u = function(t, e, i) {
              return 0 !== t
            ...
            const t = e.getPixelForDecimal(0), s = e.getPixelForDecimal(1),
                  o = Math.min(t, s), h = Math.max(t, s);
            x = Math.max(Math.min(x, h), o), d = x + u,
            i && !c &&
        ...
        draw() {
          ...
          let n = 0;
          for (; n < s; ++n)
            null === this.getParsed(n)[e.axis] || i[n].hidden ||
                i[n].draw(this._ctx)
        }
      },
                        BubbleController :
        ...
        getLabelAndValue(t) {
          const e = this._cachedMeta, i = this.chart.data.labels || [],
                {xScale : s, yScale : n} = e, o = this.getParsed(t),
                a = s.getLabelForValue(o.x), r = n.getLabelForValue(o.y),
                l = o._custom;
          return {
            label: i[t] || "",
                value: "(" + a + ", " + r + (l ? ", " + l : "") + ")"
        ...
        update(t) {
          ...
          mt(e) && (a = 0, r = s.length), i._chart = this.chart,
        ...
        updateElements(t, e, i, n) {
          ...
          for (let i = 0; i < _; ++i) {
            ...
            const v = this.getParsed(i), M = s(v[f]),
                  w = _[u] = a.getPixelForValue(v[u], i),
                  k = _[f] = o || M
                                 ? r.getBasePixel()
                                 : r.getPixelForValue(
                                       l ? this.applyStack(r, v, l) : v[f], i);
            _.skip = isNaN(w) || isNaN(k) || M,
            _.stop = i > 0 && Math.abs(v[u] - y[u]) > m,
            p && (_.parsed = v, _.raw = h.data[i]),
            d && (_.options = c || this.resolveDataElementOptions(
                                       i, g.active ? "active" : n)),
            x || this.updateElement(g, i, _, n), y = v
          }
        }
        getMaxOverflow() {
        ...
        draw() {
          ...
          RadarController : class extends js {
            ...
            updateElements(t, e, i, s) {
              ...
              for (let a = e; a < e + i; a++) {
                const e = t[a],
                      i = this.resolveDataElementOptions(a, e.active ? "active"
                                                                     : s),
            ...
            update(t) {
              ...
              if (this._drawStart = n, this._drawCount = o,
                  mt(e) && (n = 0, o = i.length), this.options.showLine) {
            ...
            updateElements(t, e, i, n) {
              ...
              for (let c = e; c < e + i; ++c) {
                const e = t[c], i = this.getParsed(c), p = b ? e : {},
                      y = s(i[g]), v = p[f] = a.getPixelForValue(i[f], c),
                      M = p[g] =
                          o || y ? r.getBasePixel()
                                 : r.getPixelForValue(
                                       l ? this.applyStack(r, i, l) : i[g], c);
                p.skip = isNaN(v) || isNaN(M) || y,
                p.stop = c > 0 && Math.abs(i[f] - _[f]) > x,
                m && (p.parsed = i, p.raw = h.data[c]),
                u && (p.options = d || this.resolveDataElementOptions(
                                           c, e.active ? "active" : n)),
                b || this.updateElement(e, c, p, n), _ = i
              }
            ...
            getMaxOverflow() {
              ...
              if (!this.options.showLine) {
                ...
                for (let i = e.length - 1; i >= 0; --i)
                  t = Math.max(t, e[i].size(this.resolveDataElementOptions(i)) /
                                      2);
                return t > 0 && t
              }
    ...
    function Kn(t, e, i, s, n, o) {
      ...
      const p = (g - Math.max(.001, g * d - i / C) / d) / 2, m = l + p + f,
            x = n - p - f,
            {outerStart : b, outerEnd : _, innerStart : y, innerEnd : v} =
                Xn(e, u, d, x - m),
            M = d - b, w = d - _, k = m + b / M, S = x - _ / w, P = u + y,
            D = u + v, O = m + y / P, A = x - v / D;
      if (t.beginPath(), o) {
        const e = (k + S) / 2;
        ...
        if (t.arc(a, r, u, x - v / u, s, !0), t.arc(a, r, u, s, m + y / u, !0),
            y > 0) {
          const e = qn(P, O, a, r);
    ...
    function Gn(t, e, i, s, n) {
      ...
      t.setLineDash(d || []),
          t.lineDashOffset = u,
          g ? (t.lineWidth = 2 * h, t.lineJoin = c || "round")
          ...
          l.selfJoin && p - a >= C && 0 === f && "miter" !== c &&
              function(t, e, i) {
               ...
               d = Math.min(h / a, G(s - i));
                if (t.beginPath(), t.arc(n, o, a - h / 2, s + d / 2, i - d / 2),
                    r > 0) {
                  ...
                  if ("round" === c)
                    ...
                    const a = 2 * e * e, r = -a * Math.cos(i + C / 2) + n,
    ...
    function to(t, e, i, s) {
      ...
      for (d = 0; d <= h; ++d)
        u = n[(r + (p ? h - d : d)) % a],
        u.skip || (g ? (t.moveTo(u.x, u.y), g = !1) : c(t, f, u, p, o.stepped),
                   f = u);
    ...
    class oo extends $s {
      ...
      interpolate(t, e) {
        ...
        const a = [], r = function(t) {
          return t.stepped                                              ? pi
                 : t.tension || "monotone" === t.cubicInterpolationMode ? mi
                                                                        : gi
        }(i);
        let l, h;
    ...
    function ho(t) {
      const e = ro(t), i = e.right - e.left, s = e.bottom - e.top,
            n = function(t, e, i) {
              const s = t.options.borderWidth, n = t.borderSkipped, o = Mi(s);
              return {
                t: lo(n.top, o.top, 0, i), r: lo(n.right, o.right, 0, e),
                    b: lo(n.bottom, o.bottom, 0, i), l: lo(n.left, o.left, 0, e)
              }
            }(t, i / 2, s / 2), a = function(t, e, i) {
              const {enableBorderRadius : s} =
                  t.getProps([ "enableBorderRadius" ]),
                                          n = t.options.borderRadius, a = wi(n),
                                          r = Math.min(e, i),
              ...
              return {
                topLeft: lo(!h || l.top || l.left, a.topLeft, 0, r),
                    ...
                    bottomLeft:
                        lo(!h || l.bottom || l.left, a.bottomLeft, 0, r),
                    bottomRight:
                        lo(!h || l.bottom || l.right, a.bottomRight, 0, r)
              }
            }(t, i / 2, s / 2);
      return {
      ...
      ArcElement : class extends $s {
        ...
        inRange(t, e, i) {
          const s = this.getProps([ "x", "y" ], i),
                ...
                f = l(d, r - a), g = J(n, a, r) && a !== r, p = f >= O || g,
                m = tt(o, h + u, c + u);
          return p && m
        }
        getCenterPoint(t) {
        ...
        draw(t) {
          ...
          t.strokeStyle = e.borderColor, function(t, e, i, s, n) {
        ...
        constructor(t) {
          super(), this.options = void 0, this.horizontal = void 0,
                   this.base = void 0, this.width = void 0,
                   this.height = void 0, this.inflateAmount = void 0,
                   t && Object.assign(this, t)
        }
        draw(t) {
          const {
        ...
        a = (r = o.radius).topLeft || r.topRight || r.bottomLeft ||
          ...
          t.save(),
              o.w === n.w && o.h === n.h ||
                  (t.beginPath(), a(t, fo(o, e, n)), t.clip(),
                   a(t, fo(n, -e, o)), t.fillStyle = i, t.fill("evenodd")),
              t.beginPath(), a(t, fo(n, e)), t.fillStyle = s, t.fill(),
                                             t.restore()
        }
        ...
        draw(t, e) {
          const i = this.options;
          this.skip || i.radius < .1 || !Re(this, e, this.size(i) / 2) ||
              (t.strokeStyle = i.borderColor, t.lineWidth = i.borderWidth,
               t.fillStyle = i.backgroundColor, Le(t, i, this.x, this.y))
        }
        getRange() {
    ...
    function xo(t, e, {horizontal : i, minRotation : s}) {
      const n = $(s), o = (i ? Math.sin(n) : Math.cos(n)) || .001,
            a = .75 * e * ("" + t).length;
    ...
    class bo extends tn {
      ...
      parse(t, e) {
        return s(t) || ("number" == typeof t || t instanceof Number) &&
                           !isFinite(+t)
                   ? null
                   : +t
      }
        ...
        const n =
          ...
          const i = [], {
            ...
            includeBounds : u
                ...
                f = o || 1, g = c - 1, {min : p, max : m} = e, x = !s(a),
                b = !s(r), _ = !s(h), y = (m - p) / (d + 1);
          ...
          "ticks" === n ? (M = Math.floor(p / S) * S, w = Math.ceil(m / S) * S)
                        : (M = p, w = m),
          x && b && o && H((r - a) / o, S / 1e3)
              ? (k = Math.round(Math.min((r - a) / S, c)), S = (r - a) / k,
                 M = a, w = r)
          : _ ? (M = x ? a : M, w = b ? r : w, k = h - 1, S = (w - M) / k)
              : (k = (w - M) / S, k = V(k, Math.round(k), S / 1e3)
                                          ? Math.round(k)
                                          : Math.ceil(k));
          const P = Math.max(U(S), U(M));
          v = Math.pow(10, s(l) ? P : l), M = Math.round(M * v) / v,
          w = Math.round(w * v) / v;
          let D = 0;
          for (x && (u && M !== a ? (i.push({value : a}), M < a && D++,
                                     V(Math.round((M + D * S) * v) / v, a,
                                       xo(a, y, t)) &&
                                         D++)
                                  : M < a && D++);
               D < k; ++D) {
    ...
    class _o extends bo {
      ...
      determineDataLimits() {
        ...
        this.min = a(t) ? t : 0, this.max = a(e) ? e : 1,
      ...
      getPixelForValue(t) {
        return null === t ? NaN
                          : this.getPixelForDecimal((t - this._startValue) /
                                                    this._valueRange)
      }
      getValueForPixel(t) {
    ...
    function ko(t, {min : e, max : i}) {
      ...
      const l = Math.pow(10, o), h = n > o ? Math.pow(10, n) : 0,
    ...
    class So extends tn {
      ...
      handleTickRangeOptions() {
        ...
        i === s && (i <= 0 ? (n(1), o(10)) : (n(vo(i, -1)), o(vo(s, 1)))),
            i <= 0 && n(vo(s, -1)), s <= 0 && o(vo(i, 1)), this.min = i,
                                                           this.max = s
      }
      buildTicks() {
        const t = this.options,
      ...
      configure() {
        const t = this.min;
        super.configure(), this._startValue = z(t),
    ...
    function Co(t) {
      const e = {
        ...
        b : t.bottom - t._padding.bottom
            ...
            i = Object.assign({}, e), s = [], o = [], a = t._pointLabels.length,
            r = t.options.pointLabels, l = r.centerPointLabels ? C / a : 0;
      for (let u = 0; u < a; u++) {
    ...
    function Oo(t, e, i, s, n) {
      ...
      let r = 0, l = 0;
      s.start<e.l ? (r = (e.l - s.start) / o, t.l = Math.min(t.l, e.l - r))
                  : s.end>e.r &&
          (r = (s.end - e.r) / o, t.r = Math.max(t.r, e.r + r)),
          n.start<e.t ? (l = (e.t - n.start) / a, t.t = Math.min(t.t, e.t - l))
                      : n.end>e.b &&
    ...
    function Ao(t, e, i) {
      const s = t.drawingArea,
            ...
            h = Math.round(Y(G(l.angle + E))), c = function(t, e, i) {
              90 === i || 270 === i ? t -= e / 2
                                    : (i > 270 || i < 90) && (t -= e);
              return t
      ...
      return {
        visible: !0, x: l.x, y: c, textAlign: d, left: u, top: c,
            right: u + r.w, bottom: c + r.h
      }
    }
    function To(t, e) {
      if (!e)
      ...
      return !(Re({x : i, y : s}, e) || Re({x : i, y : o}, e) ||
               Re({x : n, y : s}, e) || Re({x : n, y : o}, e))
    }
    function Lo(t, e, i) {
      ...
      if (!s(l)) {
        ...
        t.fillStyle = l;
        const h = n - s.left, c = o - s.top, d = a - n + s.width,
              u = r - o + s.height;
        Object.values(i).some((t => 0 !== t))
            ? (t.beginPath(), He(t, {x : h, y : c, w : d, h : u, radius : i}),
               t.fill())
            : t.fillRect(h, c, d, u)
      }
    }
    ...
    class Ro extends bo {
      ...
      determineDataLimits() {
        ...
        this.max = a(e) && !isNaN(e) ? e : 0, this.handleTickRangeOptions()
      }
      computeTickLimit() {
        ...
        bo.prototype.generateTickLabels.call(this, t),
            this._pointLabels =
                this.getLabels()
                    .map(((t, e) => {
                      const i =
                          d(this.options.pointLabels.callback, [ t, e ], this);
                      return i || 0 === i ? i : ""
                    }))
      ...
      fit() {
        const t = this.options;
        t.display && t.pointLabels.display ? Co(this)
      ...
      getIndexAngle(t) {
        return G(t * (O / (this._pointLabels.length || 1)) +
      ...
      getPointLabelContext(t) {
        ...
        if (t >= 0 && t < e.length) {
          ...
          return function(
              t, e,
              i) { return Ci(t, {label : i, index : e, type : "pointLabel"}) }(
              this.getContext(), t, i)
        }
      }
      ...
      getPointLabelPosition(t) {
        const {left : e, top : i, right : s, bottom : n} =
      ...
      drawBackground() {
        ...
        if (t) {
          const i = this.ctx;
          i.save(), i.beginPath(),
              Eo(this, this.getDistanceFromCenterForValue(this._endValue), e,
        ...
        if (e.pointLabels.display &&
            ...
            s.display && this.ticks.forEach(((t, e) => {
              if (0 !== e || 0 === e && this.min < 0) {
                ...
                const i = this.getContext(e), a = s.setContext(i),
                      l = n.setContext(i);
                !function(t, e, i, s, n) {
                  const o = t.ctx, a = e.circular,
                        {color : r, lineWidth : l} = e;
                  !a && !s || !r || !l || i < 0 ||
                      (o.save(), o.strokeStyle = r, o.lineWidth = l,
                       o.setLineDash(n.dash || []),
                       o.lineDashOffset = n.dashOffset, o.beginPath(),
                       Eo(t, i, a, s), o.closePath(), o.stroke(), o.restore())
                }(this, a, r, o, l)
              }
            })),
            i.display) {
          for (t.save(), a = o - 1; a >= 0; a--) {
            ...
            o && n &&
                (t.lineWidth = o, t.strokeStyle = n,
                 ...
                 r = this.getDistanceFromCenterForValue(e.reverse ? this.min
                                                                  : this.max),
        ...
        t.save(), t.translate(this.xCenter, this.yCenter), t.rotate(s),
            ...
            this.ticks.forEach(((s, a) => {
              ...
              if (n = this.getDistanceFromCenterForValue(this.ticks[a].value),
                ...
                t.fillRect(-o / 2 - e.left, -n - l.size / 2 - e.top,
                           o + e.width, l.size + e.height)
              }
              Ne(t, s.label, 0, -n, l, {
                color : r.color,
    ...
    class Ho extends tn {
      ...
      determineDataLimits() {
        ...
        let {min : s, max : n, minDefined : o, maxDefined : r} =
            this.getUserBounds();
        function l(t) {
      ...
      buildTicks() {
        ...
        return this._unit=e.unit||(i.autoSkip?Bo(e.minUnit,this.min,this.max,this._getLabelCapacity(n)):function(t,e,i,s,n){for(let o=zo.length-1;o>=zo.indexOf(i);o--){const i=zo[o];if(Io[i].common&&t._adapter.diff(n,s,i)>=e-1)return i}return zo[i?zo.indexOf(i):0]}(this,o.length,e.minUnit,this.min,this.max)),this._majorUnit=i.major.enabled&&"year"!==this._unit?function(t){for(let e=zo.indexOf(t)+1,i=zo.length;e<i;++e)if(Io[zo[e]].common)return zo[e]}(this._unit):void 0,this.initOffsets(s),t.reverse&&o.reverse(),No(this,o,this._majorUnit)
      }
      afterAutoSkip() {
      ...
      format(t, e) {
        const i = this.options.time.displayFormats, s = this._unit,
              n = e || i[s];
      ...
      _tickFormatFunction(t, e, i, s) {
        ...
        const a = n.time.displayFormats, r = this._unit, l = this._majorUnit,
              h = r && a[r], c = l && a[l], u = i[e],
              f = l && c && u && u.major;
      ...
      _getLabelCapacity(t) {
        const e = this.options.time, i = e.displayFormats,
              ...
              n = this._tickFormatFunction(t, 0,
                                           No(this, [ t ], this._majorUnit), s),
              o = this._getLabelSize(n),
              a = Math.floor(this.isHorizontal() ? this.width / o.w
                                                 : this.height / o.h) -
                  1;
        return a > 0 ? a : 1
      }
    ...
    var $o = Object.freeze({
      ...
      CategoryScale : class extends tn {
        ...
        configure() {
          super.configure(), this.isHorizontal() ||
      ...
      beforeElementsUpdate : (t, e, i) => {
        ...
        t.data.datasets.forEach(((e, o) => {
          ...
          if (u <= (i.threshold || 4 * n))
            return void Zo(e);
          let f;
          switch (s(a) && (e._data = h, delete e.data,
                           Object.defineProperty(e, "data", {
                             configurable : !0,
                             enumerable : !0,
                             get : function() { return this._decimated },
      ...
      return n(t) ? (s = !0, i = t)
                  : i =
                      ...
                      return e.segments.forEach((({start : t, end : e}) => {
                        e = ia(t, e, n);
                        const a = n[t], r = n[e];
                        null !== s ? (o.push({x : a.x, y : s}),
                                      o.push({x : r.x, y : s}))
                                   : null !== i && (o.push({x : i, y : a.y}),
                                                    o.push({x : i, y : r.y}))
                      })),
                             o
                    }(t, e),
      ...
      const n = function(t) {
        ...
        if (e.getPointPositionForValue)
          return function(t) {
            const {scale : e,
                   fill : i} = t,
                          s = e.options, n = e.getLabels().length,
        ...
        return function(t) {
          const {scale : e = {}, fill : i} = t, s = function(t, e) {
            ...
            return "start" === t ? i = e.bottom
                   : "end" === t ? i = e.top
                   : o(t)        ? i = e.getPixelForValue(t.value)
    ...
    function ua(t, e, i) {
      const s = da(e),
            ...
            h = a.options, c = h.fill, d = h.backgroundColor,
            {above : u = d, below : f = d} = c || {}, g = n.getDatasetMeta(o),
            p = Ni(n, g);
      s && a.points.length &&
          (Ie(t, i),
           function(t, e) {
    ...
    function ma(t, e, i, s) {
      ...
      if ("x" === o || "y" === o) {
        let e, s, l, h;
        "x" === o ? (e = a, s = n.top, l = r, h = n.bottom)
                  : (e = n.left, s = a, l = n.right, h = r),
            t.beginPath(),
            i && (e = Math.max(e, i.left), l = Math.min(l, i.right),
                  s = Math.max(s, i.top), h = Math.min(h, i.bottom)),
            t.rect(e, s, l - e, h - s), t.clip()
      }
    }
    function xa(t, e, i, s) {
    ...
    class ya extends $s {
      ...
      fit() {
        ...
        const i = t.labels, s = Si(i.font), n = s.size,
      ...
      _draw() {
        const {options : t,
               ...
               lineWidths : i,
               ctx : s} = this,
                     {align : n, labels : o} = t, a = ue.color,
                     r = Oi(t.rtl, this.left, this.width), h = Si(o.font),
                     {padding : c} = o, d = h.size, u = d / 2;
        let f;
        this.drawTitle(), s.textAlign = r.textAlign("left"),
        ...
        this.legendItems.forEach(((y, v) => {
          ...
          r.setWidth(this.width),
              x ? v > 0 && S + k + c > this.right &&
                      (P = f.y += _, f.line++,
                       S = f.x = ft(n, this.left + c, this.right - i[f.line]))
                : v > 0 && P + _ > this.bottom &&
                      (S = f.x = S + e[f.line].width + c, f.line++,
                       P = f.y = ft(n, this.top + b + c,
          ...
          if (
              function(t, e, i) {
                ...
                if (s.fillStyle = l(i.fillStyle, a),
                    ...
                    s.lineJoin = l(i.lineJoin, "miter"), s.lineWidth = n,
                  ...
                  const o = e + Math.max((d - p) / 2, 0),
                        a = r.leftForLtr(t, g), l = wi(i.borderRadius);
                  s.beginPath(),
      ...
      drawTitle() {
        ...
        if (!e.display)
          return;
        const n = Oi(t.rtl, this.left, this.width), o = this.ctx,
        ...
        if (this.isHorizontal())
          ...
          h = l + ft(t.align, this.top,
                     this.bottom - e - t.labels.padding -
                         this._computeTitleHeight())
        }
        const u = ft(a, c, c + d);
        o.textAlign = n.textAlign(ut(a)), o.textBaseline = "middle",
      ...
      _getLegendItemAt(t, e) {
        ...
        if (tt(t, this.left, this.right) && tt(e, this.top, this.bottom))
          for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
            if (s = n[i], tt(t, s.left, s.left + s.width) &&
    ...
    var Ma = {
      ...
      stop(t) { ls.removeBox(t, t.legend), delete t.legend },
      beforeUpdate(t, e, i) {
        const s = t.legend;
            ...
            return t._getSortedDatasetMetas().map(
                (t => {
                  const l = t.controller.getStyle(i ? 0 : void 0),
                        h = ki(l.borderWidth);
                  return {
                    text: e[t.index].label, fillStyle: l.backgroundColor,
                        fontColor: o, hidden: !t.visible,
                        lineCap: l.borderCapStyle, lineDash: l.borderDash,
                        lineDashOffset: l.borderDashOffset,
                        lineJoin: l.borderJoinStyle,
                        lineWidth: (h.width + h.height) / 4,
                        strokeStyle: l.borderColor,
                        pointStyle: s || l.pointStyle, rotation: l.rotation,
    ...
    class wa extends $s {
      ...
      _drawArgs(t) {
        ...
        return this.isHorizontal()
                   ...
                   : ("left" === o.position
                          ? (l = i + t, h = ft(a, s, e), c = -.5 * C)
                          : (l = n - t, h = ft(a, e, s), c = .5 * C),
                      r = s - e),
        {
    ...
    function Ta(t, e) {
      const i = t.chart.ctx, {body : s, footer : n, title : o} = t,
            {boxWidth : a, boxHeight : r} = e, l = Si(e.bodyFont),
            h = Si(e.titleFont), c = Si(e.footerFont), d = o.length,
      ...
      if (b += t.beforeBody.length + t.afterBody.length,
          d && (m += d * h.lineHeight + (d - 1) * e.titleSpacing +
                     e.titleMarginBottom),
          b) {
        m += g * (e.displayColors ? Math.max(r, l.lineHeight) : l.lineHeight) +
             (b - g) * l.lineHeight + (b - 1) * e.bodySpacing
      }
      f && (m +=
      ...
      return i.save(),
             i.font = h.string, u(t.title, y), i.font = l.string,
             u(t.beforeBody.concat(t.afterBody), y),
             _ = e.displayColors ? a + 2 + e.boxPadding : 0,
             u(s, (t => {u(t.before, y), u(t.lines, y), u(t.after, y)})), _ = 0,
             i.font = c.string, u(t.footer, y), i.restore(), x += p.width, {
        width: x, height: m
      }
    }
    function La(t, e, i, s) {
    ...
    function Ra(t, e, i, s) {
      ...
      return "center" === l ? "left" === r ? g += h : "right" === r && (g -= h)
    ...
    class Wa extends $s {
      ...
      constructor(t) {
        super(),
            ...
            this.$context = void 0, this.chart = t.chart,
            this.options = t.options, this.dataPoints = void 0,
            this.title = void 0, this.beforeBody = void 0, this.body = void 0,
      ...
      getContext() {
        return this.$context ||
               (this.$context =
                    (t = this.chart.getContext(), e = this,
                     i = this._tooltipItems,
                     Ci(t, {tooltip : e, tooltipItems : i, type : "tooltip"})));
        var t, e, i
      }
      getTitle(t, e) {
        const {callbacks : i} = e, s = Ba(i, "beforeTitle", this, t),
                           n = Ba(i, "title", this, t),
      ...
      getBody(t, e) {
        ...
        return u(t, (t => {
                   ...
                   Ca(e.before, Oa(Ba(n, "beforeLabel", this, t))),
                       ...
                       Ca(e.after, Oa(Ba(n, "afterLabel", this, t))), s.push(e)
                 })),
               s
      }
      getAfterBody(t, e) { return za(Ba(e.callbacks, "afterBody", this, t)) }
      getFooter(t, e) {
        const {callbacks : i} = e, s = Ba(i, "beforeFooter", this, t),
      ...
      update(t, e) {
        ...
        if (s.length) {
          ...
          const e = this._size = Ta(this, i), a = Object.assign({}, t, e),
                r = Ea(this.chart, i, a), l = Ra(i, a, r, this.chart);
      ...
      drawTitle(t, e, i) {
        ...
        if (n) {
          ...
          for (t.x = Ia(this, i.titleAlign, i),
              ...
              e.textBaseline = "middle", o = Si(i.titleFont),
      ...
      _drawColorBox(t, e, i, s, n) {
        const a = this.labelColors[i], r = this.labelPointStyles[i],
              {boxHeight : l, boxWidth : h} = n, c = Si(n.bodyFont),
              d = Ia(this, "left", n), u = s.x(d),
        ...
        if (n.usePointStyle) {
          ...
          t.fillStyle = n.multiKeyBackground, Le(t, e, i, o),
          ...
          const e = s.leftForLtr(u, h), i = s.leftForLtr(s.xPlus(u, 1), h - 2),
                r = wi(a.borderRadius);
          Object.values(r).some((t => 0 !== t))
              ? (t.beginPath(), t.fillStyle = n.multiKeyBackground,
                 He(t, {x : e, y : g, w : h, h : l, radius : r}), t.fill(),
                 t.stroke(), t.fillStyle = a.backgroundColor, t.beginPath(),
                 He(t, {x : i, y : g + 1, w : h - 2, h : l - 2, radius : r}),
                 t.fill())
              : (t.fillStyle = n.multiKeyBackground, t.fillRect(e, g, h, l),
                 t.strokeRect(e, g, h, l), t.fillStyle = a.backgroundColor,
      ...
      drawBody(t, e, i) {
        ...
        const g = Oi(i.rtl, this.x, this.width),
              p = function(
                  i) { e.fillText(i, g.x(t.x + f), t.y + d / 2), t.y += d + n },
              m = g.textAlign(o);
        let x, b, _, y, v, M, w;
        for (e.textAlign = o, e.textBaseline = "middle", e.font = c.string,
            t.x = Ia(this, m, i), e.fillStyle = i.bodyColor,
            u(this.beforeBody, p),
            f = a && "right" !== m ? "center" === o ? l / 2 + h : l + 2 + h : 0,
            y = 0, M = s.length;
             y < M; ++y) {
          for (x = s[y], b = this.labelTextColors[y], e.fillStyle = b,
              u(x.before, p), _ = x.lines,
              a && _.length &&
      ...
      drawFooter(t, e, i) {
        ...
        if (n) {
          ...
          for (t.x = Ia(this, i.footerAlign, i), t.y += i.footerMarginTop,
              e.textAlign = r.textAlign(i.footerAlign),
              e.textBaseline = "middle", o = Si(i.footerFont),
      ...
      _updateAnimationTarget(t) {
        ...
        if (s || n) {
          const i =
              Da[t.position].call(this, this._active, this._eventPosition);
          if (!i)
            return;
          const o = this._size = Ta(this, t),
                a = Object.assign({}, i, this._size), r = Ea(e, t, a),
                l = Ra(t, a, r, e);
          s._to === l.x && n._to === l.y ||
      ...
      draw(t) {
        ...
        e.enabled && a &&
            (t.save(), t.globalAlpha = i, this.drawBackground(n, t, s, e),
             Ai(t, e.textDirection), n.y += o.top, this.drawTitle(n, t, e),
             this.drawBody(n, t, e), this.drawFooter(n, t, e),
             Ti(t, e.textDirection), t.restore())
      }
      getActiveElements() { return this._active || [] }
      setActiveElements(t, e) {
        ...
        (n || o) && (this._active = s, this._eventPosition = e,
      ...
      _getActiveElements(t, e, i, s) {
        ...
        if (!s)
          return e.filter(
              (t => this.chart.data.datasets[t.datasetIndex] &&
                    void 0 !== this.chart.getDatasetMeta(t.datasetIndex)
    ...
    var Na = {
      ...
      positioners : Da,
      afterInit(t, e,
                i) { i && (t.tooltip = new Wa({chart : t, options : i})) },
    ...
    return Tn.register(Un, $o, go, t),
           Tn.helpers = {...Hi}, Tn._adapters = In, Tn.Animation = As,
           Tn.Animations = Ts, Tn.animator = bt,
           Tn.controllers = nn.controllers.items, Tn.DatasetController = js,
           Tn.Element = $s, Tn.elements = go, Tn.Interaction = Ki,
           Tn.layouts = ls, Tn.platforms = Ds, Tn.Scale = tn, Tn.Ticks = ae,
           Object.assign(Tn, Un, $o, go, t, Ds), Tn.Chart = Tn,
           "undefined" != typeof window && (window.Chart = Tn), Tn
  }));
